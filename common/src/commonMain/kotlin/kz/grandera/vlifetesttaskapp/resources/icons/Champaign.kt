...
public val Icons.Champaign: ImageVector
    get() {
        if (_champaign != null) {
            return _champaign!!
        }
        _champaign = Builder(name = "Champaign", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _champaign: ImageVector? = null
